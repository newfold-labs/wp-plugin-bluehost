...
/**
 * Yoast Ad 
 * @returns {JSX.Element} yoast ad component
 */
const YoastAd = () => {
	return (
		<div className="yoast-ad nfd-p-6 nfd-rounded-lg nfd-text-slate-600 nfd-bg-white nfd-shadow nfd-border">
			...
			<h2 className="yoast-ad-title nfd-title nfd-title--2 nfd-mt-6 nfd-text-xl nfd-font-semibold">Yoast SEO Premium</h2>
			...
			<p className="nfd-text-center nfd-text-xs nfd-font-normal nfd-leading-5 nfd-text-slate-500 nfd-italic nfd-mt-3 nfd-mb-2">Less friction. Faster publishing.</p>
