...
$help_svg = '<svg viewBox="0 0 539.47 338.14" xmlns="http://www.w3.org/2000/svg">
...
<div class="nfd-root nfd-widget nfd-widget-help">
	...
	<p class="nfd-flex nfd-flex-col nfd-gap-4 nfd-items-center nfd-text-center nfd-mt-4">
		<?php esc_html_e( 'From DIY to full-service help.', 'wp-plugin-bluehost' ); ?><br /><br />
		...
		<a 
			...
			<?php
				...
				// Bluehost India https://www.bluehost.in/hosting/help/
				echo esc_url(
