 ...
 *
 * We intentionally avoid `wp eval get_transient(...)` here because those checks
 * can add significant memory pressure across the full Playwright suite. Runtime
 * verification happens in `expectNewfoldSolutionsHydrated()` after navigation.
 *
