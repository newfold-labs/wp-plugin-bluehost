...
// WordPress root (same as wp-browser WP_ROOT_FOLDER).
$wp_root = getenv( 'WP_ROOT_FOLDER' );
if ( $wp_root === false || $wp_root === '' ) {
	$wp_root = 'wordpress';
}
...
// Required by wp-phpunit bootstrap.
define( 'WP_TESTS_DOMAIN', getenv( 'TEST_SITE_WP_DOMAIN' ) ?: 'localhost:8888' );
define( 'WP_TESTS_EMAIL', getenv( 'TEST_SITE_ADMIN_EMAIL' ) ?: 'email@example.org' );
define( 'WP_TESTS_TITLE', getenv( 'WP_TESTS_TITLE' ) ?: 'Test' );
